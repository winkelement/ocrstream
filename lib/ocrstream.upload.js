...
jQuery(document).ready(function () {
    jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_1.php', {ref: resourceId, ocr_lang: ocr_lang, param_1: 'none'}, function (data) {
        ...
        jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_2.php', {ref: stageOneOutput[0], ocr_lang: ocr_lang, ocr_psm: ocr_psm, param_1: 'none', w: 0, h: 0, x: 0, y: 0}, function (data) {
            ...
            jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_3.php', {ref: stageTwoOutput[0], ocr_lang: ocr_lang, ocr_psm: ocr_psm, param_1: 'none'}, function (data) {
                ...
                jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_4.php', {ref: stageThreeOutput[0]}, function (data) {
