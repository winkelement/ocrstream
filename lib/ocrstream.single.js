...
function showLoadingImage() {
    jQuery('#ocr_status_anim').append('<div id="loading-image"><img src="../plugins/ocrstream/gfx/ocrstream_loader.gif" alt="Loading..."  style="margin-left:17px" /></div>');
};
...
jQuery(document).ready(function () {
    ...
    jQuery('[name="ocr_start"]').click(function () {
        ...
        jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_1.php', {ref: resourceId, ocr_lang: ocr_lang}, function (data) {
            ...
            jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_2.php', {ref: resourceId, ocr_lang: ocr_lang, ocr_psm: ocr_psm, param_1: param_1, w: w, h: h, x: x, y: y}, function (data) {
                ...
                jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_3.php', {ref: resourceId, ocr_lang: ocr_lang, ocr_psm: ocr_psm, param_1: param_1}, function (data) {
                    ...
                    jQuery.get(baseUrl + '/plugins/ocrstream/pages/stage_4.php', {ref: resourceId}, function (data) {
